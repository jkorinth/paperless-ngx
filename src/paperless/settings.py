...
CONSUMER_CREATE_CORRESPONDENTS_FROM_PDF_METADATA: Final[str] = __get_boolean(
    "PAPERLESS_CONSUMER_CREATE_CORRESPONDENTS_FROM_PDF_METADATA",
)

CONSUMER_PDF_METADATA_CORRESPONDENT_TAG: Final[str] = os.getenv(
    "PAPERLESS_CONSUMER_PDF_METADATA_CORRESPONDENT_TAG",
    "",
)
